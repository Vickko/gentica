...
// WebpageRequest represents the request options for the webpage scraping endpoint
type WebpageRequest struct {
	URL             string `json:"url"`
	IncludeMarkdown *bool  `json:"includeMarkdown,omitempty"`
}

// WebpageResponse represents the response from the webpage scraping endpoint
type WebpageResponse struct {
	Text     string          `json:"text,omitempty"`
	Markdown string          `json:"markdown,omitempty"`
	Metadata WebpageMetadata `json:"metadata,omitempty"`
	Credits  int             `json:"credits,omitempty"`
}

// WebpageMetadata represents metadata extracted from the webpage
type WebpageMetadata struct {
	Title                  string `json:"title,omitempty"`
	Description            string `json:"description,omitempty"`
	AppleMobileWebAppTitle string `json:"apple-mobile-web-app-title,omitempty"`
	...
	OGImageWidth           string `json:"og:image:width,omitempty"`
	OGImageHeight          string `json:"og:image:height,omitempty"`
